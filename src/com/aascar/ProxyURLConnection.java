...
abstract public class ProxyURLConnection extends URLConnection {
     ...
     * @param u the URL
     */
    protected ProxyURLConnection (URL u) {
        super(u);
    }
    ...
    public int getResponseCode() throws IOException {
        ...
        if (responseCode != -1) {
            ...
            + "Connection TimeOut time : " + getConnectTimeout() + "\n"
            + "TimeStamp : " + getDate() + "\n"
    ...
    public String getResponseMessage() throws IOException {
        getResponseCode();
        System.out.print("from proxy class:--------------->" + responseMessage);
